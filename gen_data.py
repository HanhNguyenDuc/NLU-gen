...
def backtrack(slots_list, slots_values, i, res):
    '''
    ...
    for value in values:
        ...
        if i == len(slots_list) - 1:
            ...
            backtrack(slots_list, slots_values, i+1, current_result)
...
def process_template(json_data):
    ...
    socketio.emit("get_slot", slot_list)
...
def process_slots(json_data):
    ...
    backtrack(slots_list, slots_values, 0, message)
    
    socketio.emit("show_data", messages_list)
